...
```{r highlow,echo=FALSE,fig.height=7, fig.width=9}
...
```{r journey_heatmap, echo=FALSE, fig.height=9, fig.width=12, message=FALSE, warning=FALSE}
...
Below is a summary of the website journeys looking at data from **`r pre_start_date` to `r last_valid_date`**. 
...
```{r anomaly_plots,echo=FALSE,fig.height=5, fig.width=7}

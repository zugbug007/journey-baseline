...
datatable(marketing_channels_by_week_channel %>% 
            filter(`Week Num` == last_complete_week_no) %>% 
  arrange(desc(`Total Revenue`))) %>% formatCurrency(4:8, currency = "£")
...
datatable(paid_search_last_week) %>% formatCurrency(4:8, currency = "£")
...
datatable(paid_social_last_week) %>% formatCurrency(4:8, currency = "£")
...
datatable(affiliates_last_week) %>% formatCurrency(4:8, currency = "£")

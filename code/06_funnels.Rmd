...
```{r membership_funnel_pre, fig.align='center', echo=FALSE}
...
```{r membership_funnel_post, fig.align='center',echo=FALSE}
...
Start: **`r start_7_sun_start` to `r end_7_sun_end`**. 
```{r membership_funnel_post_start,fig.align='center',echo=FALSE}
...
Start: **`r start_7_sun_start` to `r end_7_sun_end`**. 
```{r shop_funnel_post, fig.align='center',echo=FALSE}

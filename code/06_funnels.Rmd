...
# # Journey Name:
# paste0('Insight for Journey: ', journey.insight$journey_name,'.')
# # min
# paste0('[Min] The lowest amount of Visits was ', journey.insight$min.Visits, ' observed on ', format(journey.insight$min.Visits.Date.Name, "%d %b"), '.')
# # average
# paste0('[Average] This was ', journey.insight$min.avg.diff, '% less than the average of ', journey.insight$avg.Visits, '.')
# # max
# paste0('[Max] During this period, the amount of Visits peaked at ', journey.insight$max.Visits, ' on ', format(journey.insight$max.Visits.Date.Name, "%d %b"), '.')
# # spike
# paste0('[Spike] The most recent peak in Visits increased notably on ', format(journey.insight$Day, "%d %b"), 
#        ' where a significant peak of ',journey.insight$Visits, ' Visits was observed. This was at least 2 Standard Deviations above the mean.')
# # Trend
# paste0('[Trend] Throughout the duration of the analysis period, the overall trend has been ',journey.insight$trend.slope.correlation ,'.',' In the previous week the trend was ', journey.insight$correlation.14,', over the last 7 days the trend has been ', journey.insight$correlation.7, '. This is a ', journey.insight$trend.change.relative, '% difference from the previous week.')
```

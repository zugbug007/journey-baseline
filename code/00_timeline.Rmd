...
timeline_data <- data.frame(event = c("Pre Launch (Old CMS)", "New CMS", "Pre Baseline (30 Days)", paste0("Post Baseline (",days_since_launch," Days)")),
                            start = c(first_valid_date, post_start_date, pre_end_date_30, baseline_post_start_date),

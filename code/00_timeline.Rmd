...
timeline_data <- data.frame(event = c("Pre Launch (Old CMS)", "Post Launch (New CMS)", "30 Day Baseline"),
                            start = c(first_valid_date, post_start_date, pre_end_date_30),
                            end = c(pre_end_date, last_valid_date, pre_end_date),
                            group = c("CMS Launch","CMS Launch", "Baseline"),
                            color = c("#406882", "#f05454", "#688240"))
                            
hc_vistime(timeline_data, optimize_y = TRUE, title = "CMS Launch Timeline") %>% highcharter::hc_size(height = 250)

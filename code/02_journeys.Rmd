...
There are currently **`r journey_low_count`** journeys performing lower than their baseline. These are flagged below for potential review.  
...
Below is the journey heat map. Each row represents a journey by day for the last 90 days.  
...
last_complete_week_no <- current_week_no-1
marketing_channels_by_week_channel <-  marketing_channels_by_week_channel %>% 
  filter(`Week Num` == last_complete_week_no) %>% arrange(desc(`Total Revenue`))

datatable(marketing_channels_by_week_channel[1:8],options = list(pageLength = 25), rownames = FALSE) %>% 
   formatCurrency(4:8, currency = "£")
...
Paid Search Revenue - Last 4 Weeks

```{r paid_media_search, echo=FALSE, fig.height=5, fig.width=7, fig.align='center',message=FALSE, warning=FALSE}

datatable(paid_search_last_week[1:8], rownames = FALSE) %>% formatCurrency(4:8, currency = "£")
...
Paid Social Revenue - Last 4 Weeks

```{r paid_media_social, echo=FALSE, fig.height=5, fig.width=7, fig.align='center',message=FALSE, warning=FALSE}

datatable(paid_social_last_week[1:8], rownames = FALSE) %>% formatCurrency(4:8, currency = "£")

```
#### Affiliates

Affiliates Revenue - Last 4 Weeks

```{r affiliates_channel, echo=FALSE, fig.height=5, fig.width=7, fig.align='center',message=FALSE, warning=FALSE}

datatable(affiliates_last_week[1:8], rownames = FALSE) %>% formatCurrency(4:8, currency = "£")

...
Each journey analysed by a specific metric. Sorted by the largest differences between the pre and post data, top to bottom.
...
Click the legend to show or hide the data for each week. Percentages in brackets are the share of the week's visit volumes. 
